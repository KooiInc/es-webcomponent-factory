...
${o}`,report_defaultValue:(o,r)=>o?"":`
In plaats daarvan wordt de voor dit contract toegekende standaardwaarde (${t(r,Function)?r.toString():t(r,String)?`"${r}"`:e(r)}) gebruikt`}}}var s,F=z,v=q(),A=J();function z(t){l(t);let{reporter:e,logViolations:n,alwaysThrow:o,language:r,contractsPrefix:a}=t;s=H({IS:u,tryJSON:N,contractsPrefix:a})[r];let c={addContract:b,addContracts:d};return U(c),Object.freeze({contracts:c,IS:u,tryJSON:N});function l(i){i.reporter=i.reporter||E,i.logViolations=i.logViolations||!1,i.alwaysThrow=i.alwaysThrow||!1,i.language=i.language||"EN"}function d(i){if(!c.addContracts_Contract(i))return;let m=Object.entries(i);for(let[p,h]of m)b({...h,paramsChecked:!0,name:p})}function b(i=v.addContract){let{name:m,method:p,expected:h,defaultValue:y,customReport:g,reportFn:O,shouldThrow:V,reportViolationsByDefault:x,paramsChecked:w}=i;m=m||p?.name;let B=c.addContract_Contract||A.checkSingleContractParameters;if(!w&&!B({name:m,method:p,expected:h}))return;let D=W({name:m,method:p,expected:h,defaultValue:y,reporter:e,reportFn:O,customReport:g,reportViolationsByDefault:x,logViolations:n,shouldThrow:V,alwaysThrow:o});return Object.defineProperty(c,m,{value:D,enumerable:!0})}}function W(t=v.createContract){let{name:e,method:n,expected:o,defaultValue:r,customReport:a,reportFn:c,reporter:l,logViolations:d,shouldThrow:b,reportViolationsByDefault:i,alwaysThrow:m}=t;return function(p,...h){let y=n(p,...h),g=u(h[0],Object)&&{...h[0],value:p}||{value:p};if(c=c??l??E,u(a,Function)&&a(g),$(y)){let O=u(o,Function)?o(g):o;y=!$(g.defaultValue)||r?g.defaultValue||r:y;let[V,x]=[g.reportViolation??i,g.shouldThrow??b];if(V||x||d){let w=K({inputValue:p,defaultValue:y,shouldBe:O,fnName:e||n.name});if(x||m)throw new TypeError(w);l(w)}}return y}}function q(){let[t,e,n,o,r,a,c]=[...Array(7)];return{get reportViolations(){return{inputValue:c,defaultValue:o,shouldBe:s.unknowOrNa,fnName:s.unknown}},get createContract(){return{name:t,method:e,expected:n,defaultValue:o,customReport:r,reportFn:a,reporter:E,logViolations:!1,shouldThrow:!1,alwaysThrow:!1,reportViolationsByDefault:!1}},get addContract(){return{name:t,method:e,expected:n,defaultValue:o,customReport:r,reportFn:a,reporter:E,shouldThrow:!1,reportViolationsByDefault:!1,paramsChecked:!1}}}}function J(){let t=o=>u(o,String)&&o.trim().length,e=o=>u(o,String)&&o.length||u(o,Function),n=o=>u(o,Function);return{nameOk:t,expectedOk:e,isMethod:n,checkSingleContractParameters:({name:o,method:r,expected:a}={})=>o&&t(o)&&r&&n(r)&&a&&e(a)}}function U(t){let{nameOk:e,expectedOk:n,isMethod:o,checkSingleContractParameters:r}=A;t.addContract({method:e,expected:s.nameOkExpected,reportViolationsByDefault:!0}),t.addContract({method:o,expected:s.isMethodExpected,reportViolationsByDefault:!0}),t.addContract({method:n,expected:s.expectedOkExpected,reportViolationsByDefault:!0}),t.addContract({name:"addContracts_Contract",method:a=>u(a,Object)&&[...Object.entries(a)].filter(([,c])=>c.method&&o(c.method)&&c.expected&&n(c.expected)).length>0?a:void 0,expected:s.addContracts_Contract_Expected,reportViolationsByDefault:!0}),t.addContract({name:"addContract_Contract",method:r,expected:s.addContract_Contract_Expected,reportViolationsByDefault:!0})}function K(t=v.reportViolations){let{inputValue:e,defaultValue:n,shouldBe:o,fnName:r}=t,a=s.report_sorry(r,G(e)),c=s.report_forValue(a),l=s.report_Expected(o),d=s.report_defaultValue($(n),n);return Q(`${c}${l}${d}`)}function Q(t,e=3){return t.replace(/\n/g,`
